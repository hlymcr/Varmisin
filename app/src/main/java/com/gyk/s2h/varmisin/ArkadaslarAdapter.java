...
//Arkadaşlarımızın arkadaşları listemizi doldurmamızı sağlayan class
public class ArkadaslarAdapter extends BaseAdapter {
    ...
    public ArkadaslarAdapter(Context activity, ArrayList<ArkadasModel> kullaniciList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final View satir = layoutInflater.inflate(R.layout.arkadaslari_list_item, null);
